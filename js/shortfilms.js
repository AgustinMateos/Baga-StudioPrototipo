...
cuerpoShortfilms = document.querySelector(".fondo"),
tituloShortfilms = document.querySelector(".contendor__TituloCortos"),
premiosContainer = document.querySelector(".shortfilms__premios__container"),
...
function abrirVideo1() {
    ...
    tituloShortfilms.classList.add("desaparecer");
    premiosContainer.classList.add("desaparecer");
    cuerpoShortfilms.classList.remove("cuerpo");
...
function cerrarVideo1() {
    ...
    tituloShortfilms.classList.remove("desaparecer");
    premiosContainer.classList.remove("desaparecer");
    cuerpoShortfilms.classList.add("cuerpo");
}
